...
# Создаём сортированный список из множества students:
students_sort = sorted(students)

# Создаём список средних оценок из списка grades:
...
# Создаём словарь из полученных списков:
dictionary = dict(zip(students_sort, average_grades))
